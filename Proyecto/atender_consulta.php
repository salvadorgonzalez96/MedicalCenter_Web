...
if($accion=="guardar"){
    ...
    $sql = "
        ...
        $result=mysqli_query($conexion,$sql);
        if($result){
            echo "<script>alert('Consulta Atendida Exitosamente!');</script>";
                echo "<script>window.open('consulta_medica.php','_self');</script>";
        }
        else {
...
<body>
    ...
    <div class="container content-invoice">
        <form action="" id="invoice-form" method="post" class="invoice-form" role="form" novalidate> 
            ...
            <a href="consulta_medica.php"><img src="img/back.png"/></a>

            <div class="load-animate animated fadeInUp">
                <div class="row">
                    <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                        <h2 class="title">Atender Consulta</h2>
                    </div>		    		
                </div>
                ...
                <div class="row">	
                    <div class="col-xs-12 col-sm-3 col-md-3 col-lg-5 pull-center">
                        <div class="form-group">
                            <button name='invoice_btn' onClick="return validar();" class="btn btn-success submit_btn invoice-save-btm">Terminar Consulta</button>
                        </div>
                        <br>
                    </div>
                </div>
