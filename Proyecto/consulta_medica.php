    ...
    <div class="container">
        ...
        <?php
                $sql="select
                        *
                        FROM tbl_cita c
                        left outer join tbl_cliente cl on cl.cliente_id=c.cita_cliente_id
                        where c.cita_servicio like 'consulta%'
                ...
                while($row=mysqli_fetch_assoc($result)){
                    ...
                    <tr>
                        ...
                        <td><a href="imprimir_consulta.php?update_id='.$row["cita_codigo"].'" TARGET="_blank"  title="Reporte de Consulta"><div class="btn btn-primary"><span><i><img src="img/print.png"/></i></span></div></a></td>
                        ';
...
if($_SESSION["M8-1"]==1){
                        ...
                        echo'
                        <td><a href="atender_consulta.php?update_id='.$row["cita_codigo"].'"  TARGET="_self" title="Atender Consulta"><div class="btn btn-primary"><span><i><img src="img/attend.png"/></i></span></div></a></td>
                    </tr>';
                    }
}
                }
