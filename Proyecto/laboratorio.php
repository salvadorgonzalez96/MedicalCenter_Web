...
<head>
	<meta charset="utf-8">
	<title>Lista de Servicios Laboratorio</title>
...
<body>
    ...
    <div class="container">
        ...
        <h2 class="title">Lista de Servicios de Laboratorio </h2> 
        ...
        <?php
                $sql="select
                        *
                        ...
                        where c.cita_servicio like 'examen%' or c.cita_servicio like 'prueba%'
                ...
                while($row=mysqli_fetch_assoc($result)){
                    ...
                    <tr>
                        ...
                        <td><a href="imprimir_lab.php?update_id='.$row["cita_codigo"].'" TARGET="_blank"  title="Reporte de Examen"><div class="btn btn-primary"><span><i><img src="img/print.png"/></i></span></div></a></td>
                        ';
if($row["cita_estado"]!="ATENDIDO"){
                        echo'
                        <td><a href="realizar_examen.php?update_id='.$row["cita_codigo"].'"  TARGET="_self" title="Realizar Examen"><div class="btn btn-primary"><span><i><img src="img/attend.png"/></i></span></div></a></td>
                    </tr>';
}
                }
